/* eslint-disable */
function init(workflowObj, ruleStepList) {
  ...
  myDiagram.toolManager.relinkingTool.temporaryLink.routing =
    go.Link.Orthogonal;
  load(workflowObj); // load an initial diagram from some JSON text
  ...
  myPalette = $(
    ...
    "myPaletteDiv", // must name or refer to the DIV HTML element
    {
      ...
      model: new go.GraphLinksModel(ruleStepList),
    }
  );
}
...
function load(workflowObj) {
  myDiagram.model = go.Model.fromJson(workflowObj);
}
